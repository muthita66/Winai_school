...
export function AdvisorsFeature() {
    ...
    return (
        <div className="space-y-6">
            <section className="bg-gradient-to-br from-rose-600 to-pink-700 rounded-3xl p-8 text-white shadow-lg relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-rose-100 mt-2">ปี {year} ภาค {semester} ({advisors.length} รายการ)</p>
                </div>
            </section>
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-200 flex flex-col sm:flex-row gap-3 sm:items-end">
                ...
                <button onClick={load} className="px-5 py-2 bg-rose-600 text-white rounded-xl font-medium hover:bg-rose-700 transition-colors">
                    โหลด
                </button>
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="bg-slate-50 border-b border-slate-200">
                                ...
                                <th className="px-4 py-3 text-left text-sm font-semibold text-slate-600">ปี/ภาค</th>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-2xl rounded-2xl bg-white shadow-2xl border border-slate-200 max-h-[90vh] overflow-hidden">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <label className="block md:col-span-2">
                                    ...
                                    <select
                                        ...
                                        className="mt-1 w-full rounded-xl border border-slate-200 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-rose-500 bg-white"
                                    >
                                ...
                                <label className="block">
                                    ...
                                    >
                                        ...
                                        {classLevelOptions.map((lvl) => <option key={lvl} value={lvl}>{lvl}</option>)}
                                    </select>
                                </label>
                        ...
                        <div className="flex items-center justify-end gap-2 px-5 py-4 border-t border-slate-200 bg-slate-50">
                            ...
                            <button type="button" onClick={isCreateMode ? handleSaveCreate : handleSaveEdit} disabled={isSaving} className="px-4 py-2 rounded-xl bg-rose-600 text-white hover:bg-rose-700 disabled:opacity-60">
